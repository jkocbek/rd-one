...
export async function __e2eShouldSuccessfullyAddFacebookProviderToExistingUserOnFacebookCallback(
  app: INestApplication,
): Promise<void> {
  const sub = makeUUID();
  const email = 'auth-social-facebook.callback.success.addFacebookToExistingUser@example.com';
