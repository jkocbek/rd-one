...
export async function __e2eShouldSuccessfullyCreateProviderOnlyOnFacebookCallback(
  app: INestApplication,
): Promise<void> {
  const sub = makeUUID();
  const email = 'auth-social-facebook.callback.success.createProviderOnly@example.com';
