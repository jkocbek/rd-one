...
export async function __e2eShouldSuccessfullyAddGoogleProviderToExistingUserOnGoogleCallback(
  app: INestApplication,
): Promise<void> {
  const sub = makeUUID();
  const email = 'auth-social-google.callback.success.addGoogleToExistingUser@example.com';
