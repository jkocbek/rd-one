...
export async function __e2eShouldSuccessfullyCreateProviderOnlyOnGoogleCallback(app: INestApplication): Promise<void> {
  const sub = makeUUID();
  const email = 'auth-social-google.callback.success.createProviderOnly@example.com';
