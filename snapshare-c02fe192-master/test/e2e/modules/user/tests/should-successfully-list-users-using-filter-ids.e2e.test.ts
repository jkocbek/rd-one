...
export async function __e2eShouldSuccessfullyListUsersUsingFilterIds(app: INestApplication): Promise<void> {
  const email1 = 'user.list.success.filter.ids+user1@example.com';
  const email2 = 'user.list.success.filter.ids+user2@example.com';
  const email3 = 'user.list.success.filter.ids+user3@example.com';
